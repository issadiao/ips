...
?>
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-4"><a class="dashboard-link" href="/node/add/order">Begin a New Order</a></div>
        <div class="col-sm-12 col-md-4"><a class="dashboard-link" href="/add-to-inventory">Add an Item to Inventory</a></div>
